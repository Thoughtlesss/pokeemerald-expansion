...
static const u8 sForestNightMapPreviewPalette[] = INCBIN_U8("graphics/map_preview/forest_night/tiles.gbapal");
static const u8 sForestNightMapPreviewTiles[] = INCBIN_U8("graphics/map_preview/forest_night/tiles.4bpp.lz");
static const u8 sForestNightMapPreviewTilemap[] = INCBIN_U8("graphics/map_preview/forest_night/tilemap.bin.lz");
...
static const struct ImageData sMapPreviewImageData[IMG_COUNT] = {
    ...
    [IMG_FOREST_NIGHT] = {
        .tilesptr = sForestNightMapPreviewTiles,
        .tilemapptr = sForestNightMapPreviewTilemap,
        .palptr = sForestNightMapPreviewPalette
    }
};
