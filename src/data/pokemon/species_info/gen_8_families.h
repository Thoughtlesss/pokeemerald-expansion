...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_ROOKIDEE] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_BATTLE_ARMOR, ABILITY_BIG_PECKS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CORVIKNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_IRON_BARBS, ABILITY_BATTLE_ARMOR, ABILITY_MIRROR_ARMOR },
    ...
    [SPECIES_ARROKUDA] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_ARMOR_TAIL, ABILITY_PROPELLER_TAIL },
        .bodyColor = BODY_COLOR_BROWN,
