...
#define PAL_TAG_KEY_ITEM_BOX 0xDAED
...
static const struct SpriteTemplate sSpriteTemplate_KeyItemBox = {
    .tileTag = 0xFFFF,
    .paletteTag = PAL_TAG_KEY_ITEM_BOX,
    .oam = &sOam_KeyItemBox,
    ...
    default:
        ...
        else
        {
            ...
            case KEYITEMS_POCKET:
                ...
                if (gSaveBlock1Ptr->registeredItems[0] == gSpecialVar_ItemId)
...
static void Task_KeyItemWheel(u8 taskId) {
    ...
    case 0:
    {
        ...
        LoadSpriteSheetByTemplate(&sSpriteTemplate_KeyItemBox, 1, 0);
        ...
        for (i = 0; i < MAX_REGISTERED_ITEMS; i++) {
            ...
            if (j < MAX_SPRITES)
            {
                struct Sprite *sprite = &gSprites[j];
                sprite->oam.paletteNum = IndexOfSpritePaletteTag(PAL_TAG_KEY_ITEM_BOX);
                StartSpriteAffineAnim(sprite, i);
            }
    ...
    case 3:
        ...
        DestroyTask(taskId);
        FreeSpritePaletteByTag(PAL_TAG_KEY_ITEM_BOX);
        break;
    case 4:
